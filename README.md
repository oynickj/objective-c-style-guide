# Lunar Objective-C Style Guide

This is a style guide for Objective-C projects at Lunar Technology Corporation. It's a fork of [The New York Times' guide](https://github.com/NYTimes/objective-c-style-guide).
...
* `else` and `else if` appear on the same line as the preceding brace.
